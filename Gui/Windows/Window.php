...
class Window extends \ManiaLive\Gui\Window {
    ...
    protected function onConstruct() {
        ...
        $this->_mainWindow->setSubStyle("BgCardOnline");
        ...
        $this->_titlebar->setScriptEvents(true);
                $this->_titlebar->setPosition(0.5,0);
        ...
        $xml->setContent('<script><!--
                       main () {                                                                          
                        declare Window <=> Page.GetFirstChild("'.$this->_windowFrame->getId().'");   
    ...
    function onResize($oldX, $oldY) {
        ...
        $this->_mainWindow->setSize($this->sizeX+1, $this->sizeY);
